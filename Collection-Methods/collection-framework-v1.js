...
const PRIORITY_INITIATIVES = [
  ...
  ["03", "متابعة موحدة قابلة للإثبات", "يجمع ملف الجهة الفواتير والدفعات والتظلمات والخطط والإشعارات والالتزامات والقرارات، ويعرض للموظف مهامه ومهلها ونتيجتها.", "خفض زمن معالجة الحالة"],
